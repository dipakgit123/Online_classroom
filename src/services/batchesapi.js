...
const API_URL = 'http://127.0.0.1:8081/batches'; // Replace with your actual API URL

// Fetch all exams
export const fetchExams2 = async () => {
  try {
    const response = await axios.get('http://127.0.0.1:8081/batches');
